...
import AddClient from './AddCommon'
...
const TableHeader = props => {
    ...
    return (
        <>
            ...
            {open ? <AddClient open={open} handleClose={handleClose} type={type} setClientData={setClientData} setCommonData={setCommonData} value={value} /> : ''}
        </>
    )
}
