...
// ** Fetch Client Data
export const fetchAccountTypeData = createAsyncThunk('accountType/fetchAccountTypeData', async (data) => {
...
export const masterAccountTypeSlice = createSlice({
    name: 'accountType',
    initialState: {
        data: [],
        total: 1,
    ...
    extraReducers: builder => {
        builder.addCase(fetchAccountTypeData.fulfilled, (state, action) => {
...
export default masterAccountTypeSlice.reducer
