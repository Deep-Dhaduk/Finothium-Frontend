...
// ** Fetch Client Data
export const fetchAccountGroupData = createAsyncThunk('accountGroup/fetchAccountGroupData', async (data) => {
...
export const masterAccountGroupSlice = createSlice({
    ...
    extraReducers: builder => {
        builder.addCase(fetchAccountGroupData.fulfilled, (state, action) => {
