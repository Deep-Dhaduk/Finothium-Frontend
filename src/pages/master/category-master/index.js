...
import { category } from 'src/varibles/constant'
...
const Client = () => {
  ...
  const onSubmit = async e => {
    try {
      ...
      const response = await updateClient(editValue, { q: value })
              ...
              <Grid container spacing={6} sx={{ mb: 2 }}>
                <Grid item xs={12} sm={12}>
                  ...
                  >
                    ...
                    <FormControlLabel value={'Category'} control={<Radio />} label='Category only' />
                  </RadioGroup>
                </Grid>
              </Grid>
