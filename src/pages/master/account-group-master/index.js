  ...
  const onSubmit = async e => {
    ...
    try {
      ...
      if (!response.success) {
        ...
        setEditDialogOpen(false)
        showSuccessToast('Account Group Updated Successfully.')
      }
    } catch (error) {
    ...
    try {
      ...
      if (result.isConfirmed) {
        ...
        if (!response.success) {
          ...
          showSuccessToast('Account Group Deleted Successfully.')
        }
      }
    } catch (error) {
      console.error('An error occurred:', error)
      showErrorToast('An error occurred while deleting the account group.')
    } finally {
      setShowSpinner(false)
    }
  }
